...
**RudiaMoon**      
- 요즘 왜이렇게 게을러 지고 있는지 모르겠는데 TDD 하기 전에 미리 일어나서 준비하고 했었는데 그렇게 안되고있고. 지금 참 이걸 고치긴 해야하는데 어떻게 이 열정을 끌어올릴 수 있을까 고민이네요. - (kimsunoh - 이제 좋은 스터디원을 만났으니 곧 끌어올리게 될 것입니다. (sunohkim만큼 좋은 스터디원이 어디있어요.) 네, 저만큼 좋은 스터디원이 없습니다.)
