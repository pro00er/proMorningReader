...
public class AddCaculationTest {
	  ...
	  AddCaculation ac = null;
		...
		@Test
		public void 기본_구분자문자열에서_숫자를_제대로_파싱하는지_확인_정상값() {
		    String inputs = "3,4,3";
		    int[] inputParseResult = ac.isBasicParseNumber(inputs);
		    
		    assertArrayEquals(new int[] {3,4,3}, inputParseResult);
		}

		// @Test(expected = NumberFormatException.class)
		// public void 기본_구분자문자열에서_숫자를_제대로_파싱하는지_확인_비정상값() {
